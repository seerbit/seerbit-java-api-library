...
public class GetMerchantDemo {
   ...
   * @return response
   */
  private static JsonObject getMerchantSubscription(String token) {
    System.out.println("================== start get merchant subscription ==================");
    RecurringService recurringService = new RecurringServiceImpl(client, token);
    JsonObject response = recurringService.getMerchantSubscriptions(client.getPublicKey());
    System.out.println("================== end get merchant subscription ==================");
    return response;
  }

  /** @param args String arguments array for main function */
  public static void main(String... args) {
    String token = GetMerchantDemo.doAuthenticate();
    JsonObject response = GetMerchantDemo.getMerchantSubscription(token);
    System.out.println("get recurring merchant data response: " + response.toString());
  }
}
