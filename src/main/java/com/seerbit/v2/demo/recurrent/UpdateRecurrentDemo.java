 ...
 * @author Seerbit
 */
public class UpdateRecurrentDemo {
	 ...
	 * @return response
	 */
	private static JsonObject doUpdateSubscription(String token) {
		RecurringService recurringService;
		Subscription subscription;
		JsonObject response;

		System.out.println("================== start update subscription ==================");
		subscription = Subscription
			.builder()
			.amount("20")
			.country("KE")
		...
		response = recurringService.doUpdateSubscription(subscription);
		System.out.println("================== end update subscription ==================");
	...
	public static void main(String... args) {
		...
		token = UpdateRecurrentDemo.doAuthenticate();
		response = UpdateRecurrentDemo.doUpdateSubscription(token);
		System.out.println("get update subscription response: " + response.toString());
	}
}
